            ...
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-2xl shadow-gray-100">
                    ...
                    <p className="mt-8 text-[10px] text-gray-400 text-center leading-relaxed">
                        ...
                        <Link href="#" className="underline decoration-gray-200 hover:text-black">Terms of Service</Link> and{" "}
                        <Link href="#" className="underline decoration-gray-200 hover:text-black">Privacy Policy</Link>.
                    </p>
                </div>
